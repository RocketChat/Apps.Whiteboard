...
import ExampleSidebar from "../excalidraw/packages/excalidraw/example/sidebar/ExampleSidebar";
import initialData from "../excalidraw/packages/excalidraw/example/initialData";
import type * as TExcalidraw from "../excalidraw/packages/excalidraw/example/index";

import "../excalidraw/packages/excalidraw/example/App.scss";
...
import { EVENT, ROUNDNESS } from "../excalidraw/constants";
import { distance2d } from "../excalidraw/math";
import { fileOpen } from "../excalidraw/data/filesystem";
import { loadSceneOrLibraryFromBlob } from "../excalidraw/data/blob";
import {
  AppState,
  BinaryFileData,
  ExcalidrawImperativeAPI,
...
import { ImportedLibraryData } from "../excalidraw/data/types";
import CustomFooter from "../excalidraw/packages/excalidraw/example/CustomFooter";
import MobileFooter from "../excalidraw/packages/excalidraw/example/MobileFooter";
